// First text prompt - min of 3 characters 
// Second text prompt - text colour in hex or text
// Third prompt shape - list says : circle, triangle, square
// Shapes color - color keyword or hex
